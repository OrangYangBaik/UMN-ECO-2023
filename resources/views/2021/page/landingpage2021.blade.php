@extends('2021.template.app')

@section('custom-css')
    <link rel="stylesheet" href="{{ asset('css/2021/page/about-us2.css') }}">
@endsection
    ...
    <div id="scene-1" class="position-relative mx-auto">
        ...
        <div class="position-fixed bye-text col-10 col-lg-4 col-md-6">
            ...
            <div class="bottom-text">
                Terima kasih sudah mau menjadi bagian dari perjalanan kami, ECO Friends. Mari terus lanjutkan dampak yang telah diberikan untuk Bumi kita, ya!
            </div>
...
@section('custom-js')
    <script src="{{ asset('js/2021/page/about-us2.js') }}"></script>
