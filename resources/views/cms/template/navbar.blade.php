        ...
        <div class="navbar-collapse justify-content-around collapse" id="navbarNav">
            ...
            <ul class="navbar-nav col-10">
                <div class="nav-item-container w-100 row justify-content-end mx-auto">
                    <li class="nav-item col-4 col-md-auto text-center">
                    ...
                    <li class="nav-item col-4 col-md-auto text-center">
                        <a class="nav-link" href="{{ route('milestone-landing') }}">Milestone</a>
                    </li>
...
<nav id="main-navigation" class="nav-main">
    <ul class="menu">
        ...
        <li class="menu__item">
            <a class="menu__link" href="{{ route('milestone-landing') }}">Milestone</a>
        </li>
