        ...
        <div class="background-2"></div>
            ...
            <div class="teks-gen1">
                <div class="text-gen1">
                    ...
                    <h2 class="gen">Gen 1 <img class="arrow" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
                </div>
                <p>
            ...
            <div class="teks-gen2">
                <div class="text-gen2">
                    ...
                    <h2 class="gen-2">Gen 2 <img class="arrow-2" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
            ...
            <div class="teks-gen3">
                <div class="text-gen3">
                    ...
                    <h2 class="gen-3">Gen 3 <img class="arrow-3" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
                </div>
                <p>
            ...
            <div class="teks-gen4">
                <div class="text-gen4">
                    ...
                    <h2 class="gen-4">Gen 4 <img class="arrow-4" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
            ...
            <div class="teks-gen5">
                <div class="text-gen5">
                    ...
                    <h2 class="gen-5">Gen 5 <img class="arrow-5" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
                </div>
                <p>
            ...
            <div class="teks-gen6">
                <div class="text-gen6">
                    ...
                    <h2 class="gen-6">Gen 1 <img class="arrow-6" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
            ...
            <div class="teks-gen7">
                <div class="text-gen7">
                    ...
                    <h2 class="gen-7">Gen 2 <img class="arrow-7" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
                </div>
                <p>
           ...
           <div class="tong-sampah-8">
            ...
            <div class="teks-gen8">
                <div class="text-gen8">
                    ...
                    <h2 class="gen-8">Gen 3 <img class="arrow-8" src="{{ asset('images/milestone/Arrow.svg') }}" alt=""></h2> 
