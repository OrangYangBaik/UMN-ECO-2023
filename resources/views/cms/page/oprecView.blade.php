...
@section('content')
    ...
    <div class="main">
        <div class="position-relative section-1 container">
            ...
            @endforeach
            @foreach ($teams->unique('name') as $team)
                <img src="{{ asset('images/oprec2/gapura/' . $team->name . '.png') }}" class="asset-images gapura-lala"
                    alt="">
            @endforeach
            <!-- artboard-bg -->
            ...
            <div class="slider">
                <div class="slider-inner">
                    @foreach ($teams->unique('name') as $team)
                        <img class="slider-item" width="10%" src="{{ asset('images/oprec2/logo/' . $team->name . '.png') }}"
                            alt="">
                    @endforeach
                </div>
            </div>
        ...
        <div class="text-section container pb-5">
            @foreach ($teams->unique('name') as $team)
                <div class="content-selector">
                    <div class="row content justify-content-around">
                        <div
                            class="title-text col-12 d-flex flex-column justify-content-center align-items-md-center align-items-start text-md-center text-start">
                            <h1>{{ $team->name }}</h1>
                            <h3>{{ $team->alias }}</h3>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12 pt-2 text-start">
                            <p>
                                    ...
                                    @if ($teamsub->status)
                                        <div class="col-md-3 col-6 d-flex justify-content-center py-2">
                                            <div class="button-reg text-center">
                                                ...
                                                <a
                                                    href="/recruitmentForm/{{ $teamsub->subdivisi }}-sub"><button>Daftar</button></a>
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
