...
@section('content')
    <div class="scanner-qr-booth-game-container">
        <h1 class="mb-2 text-center">TUKAR KUPON</h1>
        <div id="reader"></div>
    </div>
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#reader__scan_region").append(
                "<img id='booth-scanner-arcade-logo' src='{{ asset('images/wehea/scanner tukar kupon.svg') }}' alt='Tukar Kupon Scanner Logo'/>"
            );
        });
            ...
            if (!ajaxSent) {
                ...
                async function performNestedAjaxCalls() {
                    try {
                        ...
                        const response1 = await makeAjaxRequest('/verificationAdmin/sendReqKurangKupon', {
                            qrcode: result,
                        });
                        ...
                        if (response1.success) {
                            ...
                            // ini dikirimnya
                            const response2 = await makeAjaxRequest('/sendDataKurangKuponToAdmin', {
                                nama: response1.nama,
                                nim: response1.nim
                            });
