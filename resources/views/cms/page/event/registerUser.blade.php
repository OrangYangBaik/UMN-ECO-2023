            ...
            <form action="/register" method="POST" id="form-register" style="width:80%; margin:auto">
                ...
                <div class="input-group">
                    <select class="form-select" id="fakultas" name="fakultas">
                        <option @if (old('fakultas') != 'Teknik dan Informatika') selected @endif value="Teknik dan Informatika">Teknik dan
                            Informatika</option>
                        <option @if (old('fakultas') === 'Bisnis') selected @endif value="Bisnis">Bisnis</option>
                        <option @if (old('fakultas') === 'Ilmu Komunikasi') selected @endif value="Ilmu Komunikasi">Ilmu Komunikasi
                        </option>
                        <option @if (old('fakultas') === 'Seni dan Desain') selected @endif value="Seni dan Desain">Seni dan Desain
                        </option>
                    </select>
                </div>
                ...
                <div class="input-group">
                    <select class="form-select" id="program-studi" name="program-studi">
                        ...
                        <option @if (old('program-studi') === 'Teknik Komputer') selected @endif value="Teknik Komputer">Teknik
                            Komputer</option>
                        <option @if (old('program-studi') === 'Teknik Elektro') selected @endif value="Teknik Elektro">Teknik Elektro
                        </option>
                ...
                <input type="text" placeholder="umn_eco" class="form-control @error('instagram') is-invalid @enderror"
                ...
                <input type="password" placeholder="Password"
                    class="form-control @error('confirmation-password') is-invalid @enderror" id="confirmation-password"
                    name="confirmation-password" value="{{ old('confirmation-password') }}">
