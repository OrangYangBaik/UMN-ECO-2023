...
<div class="outer-container-carnaval">
    <div class="container-carnaval">
      ...
      <div id="popup4" class="clickable-tenda-biru-tua">
        ...
        <p>Kalau kita berbuat sesuatu yang baik pasti tidak selalu sendirian, harus ada bantuan dari orang lain karena ada beberapa hal yang orang lain bisa lihat tetapi sedang kita tidak bisa melihatnya, begitupun sebaliknya. Sehingga untuk melakukan hal baik tersebut maka perlu untuk melengkapi satu sama lain.
        </p>
        <div class="popup-tenda">
      ...
      <div id="popup3" class="clickable-tenda-kuning">
        <h2>SANGGADENGAH</h2>
        <p>Aktivitas ini disebut juga Jawab untuk segala karena diri kita kadang gatau kita ngarah kemana, jadi kita harus selalu mempersiapkan berbagai pengetahuan dan skill buat nyelesain tantangan atau masalah dalam setiap skenario
        </p>
        <div class="popup-tenda">
      ...
      <div id="popup2" class="clickable-tenda-oren">
        <h2>JANGKAH DELES</h2>
        <p>Setiap kotak merepresentasikan tindakan yang ramah lingkungan. Namun, tidak jarang kita melakukan tindakan yang terlihat ramah lingkungan walaupun sebenarnya tetap berdampak buruk pada lingkungan. Maka dari itu, kita harus lebih cermat dan waspada ketika mengambil langkah dalam suatu tindakan.
        </p>
        <div class="popup-tenda">
