            ...
            <div class="popup" id="popup">
                <div class="popup-content">
                    ...
                    <p style="color: #004963; font-style: bobbyjones; text-align: justify;">
                        ...
                        ECO Friends tau gak? Sumber sampah terbesar ke-2 yang paling numpuk itu berasal dari baju yang kita
                        pakai!!
                    ...
                    <img id="tokoBaju2D" src="{{ asset('images/wehea/fashion/2D/toko baju.svg') }}" alt="tokoBajuPopup"
                        style="width: 50px;">
                </div>
            </div>
